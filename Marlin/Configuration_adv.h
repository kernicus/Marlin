...
#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G28XY\n" SD_FINISHED_RELEASECOMMAND      // G-code to run on Stop Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  // Tevo 78 oz-in 40mm 17HD4401-C5.18 1.8°, 1.8A max current
  #if AXIS_IS_TMC(X)
  ...
  // Creality 42-34/JKong Motor JK42HS34-0844YA-03F, 1.8 degree, 0.84A max current
  #if AXIS_IS_TMC(Z)
